...
import oozie.workflow_0_5.{ WORKFLOWu45APP, WORKFLOWu45APPOption }
 ...
 */
abstract class ScoozieCoordinatorApp[T: CanWriteXML, W: CanWriteXML](coord: Coordinator[T, W],
                                                                     wf: WorkflowApp,
 ...
 */
    ...
    def getXMLString(workflow: WorkflowApp, postprocessing: Option[XmlPostProcessing] = Some(XmlPostProcessing.Default)): String = {
        ...
        val wf = Conversion[WORKFLOWu45APP](workflow)
